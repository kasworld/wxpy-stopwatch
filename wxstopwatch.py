...
class wxStopWatch(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.label_stopwatch = wx.StaticText(self, -1, "00:00:00", style=wx.ALIGN_CENTRE)
        self.button_startstop = wx.Button(self, -1, "&Start")
        self.button_lap = wx.Button(self, -1, "C&lear")
        self.list_lap = wx.ListCtrl(self, -1, style=wx.LC_REPORT|wx.LC_NO_HEADER|wx.SUNKEN_BORDER)
        ...
        self.list_lap.InsertColumn(0, '', format=wx.LIST_FORMAT_LEFT, width=220)
    ...
    def _OnSize(self, evt):
        ...
        self.label_stopwatch.SetFont(wx.Font(fp, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, "") )
        self.Layout()
    ...
    def __set_properties(self):
        ...
        self.label_stopwatch.SetFont(wx.Font(48, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, ""))
        self.button_startstop.SetFont(wx.Font(48, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, ""))
        self.button_startstop.SetFocus()
        self.button_lap.SetFont(wx.Font(48, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, ""))
        self.list_lap.SetFont(wx.Font(24, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, ""))
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        sizer_3.Add(self.label_stopwatch, 1, wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_1.Add(sizer_3, 1, wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 0)
    ...
    def evt_lap(self, event): # wxGlade: wxStopWatch.<event_handler>
        if self.timerstarted == False :
            ...
            printstr = "%02d:%02d:%02d" % ( int(toprint) / 60 ,int(toprint)%60  , (toprint - int(toprint))*100 )
